...
export const ColorProperties: number[] = [
  PropInterface.PROP_TYPE_COLOR,
  PropInterface.PROP_TYPE_GRADIENT_COLOR,
  PropInterface.PROP_TYPE_BORDER_COLOR,
  PropInterface.PROP_TYPE_ROW_HIGHLIGHT_COLOR,
  PropInterface.PROP_TYPE_ALTERNATING_BG_COLOR,
  PropInterface.PROP_TYPE_TITLE_COLOR,
  PropInterface.PROP_TYPE_DIVIDER_COLOR,
  PropInterface.PROP_TYPE_INACTIVE_ROW_HIGHLIGHT_COLOR,
  PropInterface.PROP_TYPE_ROW_BG_COLOR,
  PropInterface.PROP_TYPE_FOCUS_COLOR,
  PropInterface.PROP_TYPE_HINT_COLOR,
  PropInterface.PROP_TYPE_HOT_TRACK_COLOR,
  PropInterface.PROP_TYPE_SELECTED_TAB_COLOR,
  PropInterface.PROP_TYPE_HOVERING_COLOR,
  PropInterface.PROP_TYPE_VISITED_COLOR,
  PropInterface.PROP_TYPE_TITLE_BAR_COLOR,
  PropInterface.PROP_TYPE_BORDER_FOCUS_COLOR
]
