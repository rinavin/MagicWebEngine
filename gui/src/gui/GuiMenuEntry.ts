...
import {Debug, Hashtable, NObject, Array_Enumerator, List} from "@magic/mscorelib";
...
export class GuiMenuEntry extends NObject {
  ...
  _instantiatedPullDown: Hashtable<GuiMgForm, MenuReference> = null;
  _instantiatedContext: Hashtable<GuiMgForm, MenuReference> = null;
  _instantiatedToolItem: Hashtable<GuiMgForm, MenuReference> = null;
  ...
  init(): void {
    ...
    this._instantiatedPullDown = new Hashtable<GuiMgForm, MenuReference>();
    this._instantiatedContext = new Hashtable<GuiMgForm, MenuReference>();
    this._instantiatedToolItem = new Hashtable<GuiMgForm, MenuReference>();
  }
  ...
  /// </returns>
  private getInstantiatedMenus_2(form: GuiMgForm, addToolBar: boolean, addPullDown: boolean, addContext: boolean): Array_Enumerator<MenuReference> {
  ...
  removeMenuIsInstantiated(guiMgForm: GuiMgForm, style: MenuStyle): void {
  ...
  /// <param name="menuStyle">the menu style (pulldown, context)</param>
  /// <returns> menu reference object</returns>
  setToolItemInstantiated(form: GuiMgForm): MenuReference {
    let menuReference: MenuReference = new MenuReference(form);
    this._instantiatedToolItem.set_Item(form, menuReference);
    return menuReference;
  }
  ...
  /// <returns> a menu object reference. In case the menu was not yet instantiated for the specfic form and
  /// style, null is returned.</returns>
  getInstantiatedToolItem(form: GuiMgForm): MenuReference {
