...
export class MgRectangle {
  ...
  constructor(x?: number, y?: number, width?: number, height?: number) {
    ...
    if (arguments.length === 4 && (x === null || x.constructor === Number) && (y === null || y.constructor === Number) && (width === null || width.constructor === Number) && (height === null || height.constructor === Number)) {
