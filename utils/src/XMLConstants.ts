export class XMLConstants {
  ...
  static readonly MG_TAG_FONT_ENTRY: string = "font";
  static readonly MG_TAG_FONTTABLE: string = "fonttable";
  ...
  static readonly MG_TAG_COLORTABLE: string = "colortable";
  static readonly MG_TAG_COLORTABLE_ID: string = "colortableId";
  static readonly MG_TAG_COLOR_ENTRY: string = "color";
  ...
  static readonly ERROR_LOG_TIME_FORMAT: string = "HH:mm:ss.f";
