...
import {MgControlBase} from "@magic/gui/src/management/gui/MgControlBase";
...
export class RemoteControlItemsRefreshCommand extends RemoteDataViewCommandBase {
  ...
  Execute(): ReturnResultBase {
    ...
    RemoteCommandsProcessor.GetInstance().Execute(CommandsProcessorBase_SendingInstruction.TASKS_AND_COMMANDS, CommandsProcessorBase_SessionStage.NORMAL, res);
