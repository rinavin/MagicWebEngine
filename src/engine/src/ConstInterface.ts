...
export class ConstInterface {
  ...
  static MG_TAG_COLORTABLE_URL: string = "ColorTblurl";
  static MG_TAG_FONTTABLE: string = "fonttable";
  static MG_TAG_FONTTABLE_URL: string = "fontTblurl";
  ...
  static MG_TAG_USER_RIGHTS: string = "userRights";
  static MG_TAG_DBH_REAL_IDXS: string = "dbhRealIdxs";
  static MG_TAG_USER_DETAILS: string = "userDetails";
  ...
  static MG_ATTR_USE_WINDOWS_XP_THEAMS: string = "UseWindowsXPThemes";
  ...
  static RC_INDICATION_INITIAL: string = "RICHCLIENT=INITIAL&"; // first request of the handshake
  static RC_INDICATION_SCRAMBLED: string = "SCRAMBLED&";
  static RC_INDICATION: string = "RICHCLIENT=Y&";
