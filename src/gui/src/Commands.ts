import {List, RefParam, Type} from "@magic/mscorelib";
import {MgFont, WindowType} from "@magic/utils";
...
export class Commands {
  ...
  static getFontMetrics(mgFont: MgFont, obj: any): MgPointF {
    let guiInteractive: GuiInteractive = new GuiInteractive();
  ...
  static getBoundsRelativeTo(obj: any, line: number, rect: MgRectangle, relativeTo: any): void {
    let guiInteractive: GuiInteractive = new GuiInteractive();
  ...
  static PointToClient(relativeTo: any, convrtPoint: MgPoint): void {
    let guiInteractive: GuiInteractive = new GuiInteractive();
  ...
  /// <param name="relativeTo"></param>
  /// <param name="convrtPoint"></param>
  static PointToScreen(relativeTo: any, convrtPoint: MgPoint): void {
    let guiInteractive: GuiInteractive = new GuiInteractive();
  ...
  /// </summary>
  static IsPointInMonitor(point: MgPoint): boolean {
    let guiInteractive: GuiInteractive = new GuiInteractive();
  ...
  ///   returns if Point is contained in any of the monitors
  /// </summary>
  static GetLeftTopLocationFormMonitor(parentForm: MgFormBase): MgPoint {
    let guiInteractive: GuiInteractive = new GuiInteractive();
  ...
  static GetMDIClientBounds(): MgRectangle {
    let guiInteractive: GuiInteractive = new GuiInteractive();
    return guiInteractive.GetMdiClientBounds();
  }
  ...
  static getDesktopBounds(rect: MgRectangle, form: MgFormBase): void {
    let guiInteractive: GuiInteractive = new GuiInteractive();
  ...
  static createDialog(handle: DialogHandler, objType: Type, parameters: any[]): void {
    let guiInteractive: GuiInteractive = new GuiInteractive();
  ...
  static checkAutoWide(guiMgControl: GuiMgControl, line: number, lenCheck: boolean): void {
    let guiInteractive: GuiInteractive = new GuiInteractive();
  ...
  ///   BEEP
  /// </summary>
  static addAsync(commandType: CommandType): void;
  ...
  /// </param>
  /// </param>
  static addAsync(commandType: CommandType, parentObject: any, obj: any, line: number, style: number, stringList: List<string>, ctrlList: List<GuiMgControl>, columnCount: number, boolVal: boolean, boolVal1: boolean, number1: number, type: Type, number2: number, obj1: any): void;

  /// <summary>
  ///  Creates edit control inside help window.
  /// </summary>
  static addAsync(commandType: CommandType, parentObject: any, obj: any, line: number, style: number, stringList: List<string>, ctrlList: List<GuiMgControl>, columnCount: number, boolVal: boolean, boolVal1: boolean, number1: number, type: Type, number2: number, obj1: any, isParentHelpWindow: boolean, dockingStyle: DockingStyle): void;
  ...
  static addAsync(commandType: CommandType, objOrParentObjectOrMnuRefOrFormOrToolbar?: any, boolValOrObj1OrLineOrNumberOrEventNameOrContainerFormOrMenuStyleOrMenuEntryOrNewToolbarOrForm?: any, formNameOrIsHelpWindowOrLayerOrNum1OrWindowTypeOrLineOrBoolValOrXOrNumberOrObjectValue1OrStrOrByteArrayOrDisplayListOrMenuStyleOrMenuEntryOrVal?: any, formNameOrLineOrNum2OrStyleOrExecuteParentLayoutOrYOrObjectValue2OrUserDropFormatOrBool1OrGuiMgMenuOrGuiMgFormOrIndex?: any, styleOrNum3OrIsHelpWindowOrStringListOrWidthOrBoolValOrIntValOrParentTypeFormOrIndex?: any, createInternalFormForMDIOrCtrlListOrHeightOrShouldShowPulldownMenu?: any, shouldBlockOrColumnCountOrBoolVal?: any, boolValOrBool1?: boolean, boolVal1?: boolean, number1?: number, type?: Type, number2?: number, obj1?: any, isParentHelpWindow?: boolean, dockingStyle?: DockingStyle): void {
    ...
    if (arguments.length === 14 && (commandType === null || commandType.constructor === Number) && (objOrParentObjectOrMnuRefOrFormOrToolbar === null || objOrParentObjectOrMnuRefOrFormOrToolbar.constructor === Object) && (boolValOrObj1OrLineOrNumberOrEventNameOrContainerFormOrMenuStyleOrMenuEntryOrNewToolbarOrForm === null || boolValOrObj1OrLineOrNumberOrEventNameOrContainerFormOrMenuStyleOrMenuEntryOrNewToolbarOrForm.constructor === Object) && (formNameOrIsHelpWindowOrLayerOrNum1OrWindowTypeOrLineOrBoolValOrXOrNumberOrObjectValue1OrStrOrByteArrayOrDisplayListOrMenuStyleOrMenuEntryOrVal === null || formNameOrIsHelpWindowOrLayerOrNum1OrWindowTypeOrLineOrBoolValOrXOrNumberOrObjectValue1OrStrOrByteArrayOrDisplayListOrMenuStyleOrMenuEntryOrVal.constructor === Number) && (formNameOrLineOrNum2OrStyleOrExecuteParentLayoutOrYOrObjectValue2OrUserDropFormatOrBool1OrGuiMgMenuOrGuiMgFormOrIndex === null || formNameOrLineOrNum2OrStyleOrExecuteParentLayoutOrYOrObjectValue2OrUserDropFormatOrBool1OrGuiMgMenuOrGuiMgFormOrIndex.constructor === Number) && (styleOrNum3OrIsHelpWindowOrStringListOrWidthOrBoolValOrIntValOrParentTypeFormOrIndex === null || styleOrNum3OrIsHelpWindowOrStringListOrWidthOrBoolValOrIntValOrParentTypeFormOrIndex instanceof List) && (createInternalFormForMDIOrCtrlListOrHeightOrShouldShowPulldownMenu === null || createInternalFormForMDIOrCtrlListOrHeightOrShouldShowPulldownMenu instanceof List) && (shouldBlockOrColumnCountOrBoolVal === null || shouldBlockOrColumnCountOrBoolVal.constructor === Number) && (boolValOrBool1 === null || boolValOrBool1.constructor === Boolean) && (boolVal1 === null || boolVal1.constructor === Boolean) && (number1 === null || number1.constructor === Number) && (type === null || type instanceof Type) && (number2 === null || number2.constructor === Number) && (obj1 === null || obj1.constructor === Object)) {
      Commands.addAsync_9(commandType, objOrParentObjectOrMnuRefOrFormOrToolbar, boolValOrObj1OrLineOrNumberOrEventNameOrContainerFormOrMenuStyleOrMenuEntryOrNewToolbarOrForm, formNameOrIsHelpWindowOrLayerOrNum1OrWindowTypeOrLineOrBoolValOrXOrNumberOrObjectValue1OrStrOrByteArrayOrDisplayListOrMenuStyleOrMenuEntryOrVal, formNameOrLineOrNum2OrStyleOrExecuteParentLayoutOrYOrObjectValue2OrUserDropFormatOrBool1OrGuiMgMenuOrGuiMgFormOrIndex, styleOrNum3OrIsHelpWindowOrStringListOrWidthOrBoolValOrIntValOrParentTypeFormOrIndex, createInternalFormForMDIOrCtrlListOrHeightOrShouldShowPulldownMenu, shouldBlockOrColumnCountOrBoolVal, boolValOrBool1, boolVal1, number1, type, number2, obj1);
      return;
    }
    if (arguments.length === 16 && (commandType === null || commandType.constructor === Number) && (objOrParentObjectOrMnuRefOrFormOrToolbar === null || objOrParentObjectOrMnuRefOrFormOrToolbar.constructor === Object) && (boolValOrObj1OrLineOrNumberOrEventNameOrContainerFormOrMenuStyleOrMenuEntryOrNewToolbarOrForm === null || boolValOrObj1OrLineOrNumberOrEventNameOrContainerFormOrMenuStyleOrMenuEntryOrNewToolbarOrForm.constructor === Object) && (formNameOrIsHelpWindowOrLayerOrNum1OrWindowTypeOrLineOrBoolValOrXOrNumberOrObjectValue1OrStrOrByteArrayOrDisplayListOrMenuStyleOrMenuEntryOrVal === null || formNameOrIsHelpWindowOrLayerOrNum1OrWindowTypeOrLineOrBoolValOrXOrNumberOrObjectValue1OrStrOrByteArrayOrDisplayListOrMenuStyleOrMenuEntryOrVal.constructor === Number) && (formNameOrLineOrNum2OrStyleOrExecuteParentLayoutOrYOrObjectValue2OrUserDropFormatOrBool1OrGuiMgMenuOrGuiMgFormOrIndex === null || formNameOrLineOrNum2OrStyleOrExecuteParentLayoutOrYOrObjectValue2OrUserDropFormatOrBool1OrGuiMgMenuOrGuiMgFormOrIndex.constructor === Number) && (styleOrNum3OrIsHelpWindowOrStringListOrWidthOrBoolValOrIntValOrParentTypeFormOrIndex === null || styleOrNum3OrIsHelpWindowOrStringListOrWidthOrBoolValOrIntValOrParentTypeFormOrIndex instanceof List) && (createInternalFormForMDIOrCtrlListOrHeightOrShouldShowPulldownMenu === null || createInternalFormForMDIOrCtrlListOrHeightOrShouldShowPulldownMenu instanceof List) && (shouldBlockOrColumnCountOrBoolVal === null || shouldBlockOrColumnCountOrBoolVal.constructor === Number) && (boolValOrBool1 === null || boolValOrBool1.constructor === Boolean) && (boolVal1 === null || boolVal1.constructor === Boolean) && (number1 === null || number1.constructor === Number) && (type === null || type instanceof Type) && (number2 === null || number2.constructor === Number) && (obj1 === null || obj1.constructor === Object) && (isParentHelpWindow === null || isParentHelpWindow.constructor === Boolean) && (dockingStyle === null || dockingStyle.constructor === Number)) {
      Commands.addAsync_10(commandType, objOrParentObjectOrMnuRefOrFormOrToolbar, boolValOrObj1OrLineOrNumberOrEventNameOrContainerFormOrMenuStyleOrMenuEntryOrNewToolbarOrForm, formNameOrIsHelpWindowOrLayerOrNum1OrWindowTypeOrLineOrBoolValOrXOrNumberOrObjectValue1OrStrOrByteArrayOrDisplayListOrMenuStyleOrMenuEntryOrVal, formNameOrLineOrNum2OrStyleOrExecuteParentLayoutOrYOrObjectValue2OrUserDropFormatOrBool1OrGuiMgMenuOrGuiMgFormOrIndex, styleOrNum3OrIsHelpWindowOrStringListOrWidthOrBoolValOrIntValOrParentTypeFormOrIndex, createInternalFormForMDIOrCtrlListOrHeightOrShouldShowPulldownMenu, shouldBlockOrColumnCountOrBoolVal, boolValOrBool1, boolVal1, number1, type, number2, obj1, isParentHelpWindow, dockingStyle);
      return;
    }
    if (arguments.length === 4 && (commandType === null || commandType.constructor === Number) && (objOrParentObjectOrMnuRefOrFormOrToolbar === null || objOrParentObjectOrMnuRefOrFormOrToolbar.constructor === Object) && (boolValOrObj1OrLineOrNumberOrEventNameOrContainerFormOrMenuStyleOrMenuEntryOrNewToolbarOrForm === null || boolValOrObj1OrLineOrNumberOrEventNameOrContainerFormOrMenuStyleOrMenuEntryOrNewToolbarOrForm.constructor === Number) && (formNameOrIsHelpWindowOrLayerOrNum1OrWindowTypeOrLineOrBoolValOrXOrNumberOrObjectValue1OrStrOrByteArrayOrDisplayListOrMenuStyleOrMenuEntryOrVal === null || formNameOrIsHelpWindowOrLayerOrNum1OrWindowTypeOrLineOrBoolValOrXOrNumberOrObjectValue1OrStrOrByteArrayOrDisplayListOrMenuStyleOrMenuEntryOrVal.constructor === Boolean)) {
    ...
    if (arguments.length === 7 && (commandType === null || commandType.constructor === Number) && (objOrParentObjectOrMnuRefOrFormOrToolbar === null || objOrParentObjectOrMnuRefOrFormOrToolbar.constructor === Object) && (boolValOrObj1OrLineOrNumberOrEventNameOrContainerFormOrMenuStyleOrMenuEntryOrNewToolbarOrForm === null || boolValOrObj1OrLineOrNumberOrEventNameOrContainerFormOrMenuStyleOrMenuEntryOrNewToolbarOrForm instanceof GuiMgForm) && (formNameOrIsHelpWindowOrLayerOrNum1OrWindowTypeOrLineOrBoolValOrXOrNumberOrObjectValue1OrStrOrByteArrayOrDisplayListOrMenuStyleOrMenuEntryOrVal === null || formNameOrIsHelpWindowOrLayerOrNum1OrWindowTypeOrLineOrBoolValOrXOrNumberOrObjectValue1OrStrOrByteArrayOrDisplayListOrMenuStyleOrMenuEntryOrVal.constructor === Number) && (formNameOrLineOrNum2OrStyleOrExecuteParentLayoutOrYOrObjectValue2OrUserDropFormatOrBool1OrGuiMgMenuOrGuiMgFormOrIndex === null || formNameOrLineOrNum2OrStyleOrExecuteParentLayoutOrYOrObjectValue2OrUserDropFormatOrBool1OrGuiMgMenuOrGuiMgFormOrIndex instanceof GuiMgMenu) && (styleOrNum3OrIsHelpWindowOrStringListOrWidthOrBoolValOrIntValOrParentTypeFormOrIndex === null || styleOrNum3OrIsHelpWindowOrStringListOrWidthOrBoolValOrIntValOrParentTypeFormOrIndex.constructor === Boolean) && (createInternalFormForMDIOrCtrlListOrHeightOrShouldShowPulldownMenu === null || createInternalFormForMDIOrCtrlListOrHeightOrShouldShowPulldownMenu.constructor === Boolean)) {
  ...
  private static addAsync_0(commandType: CommandType): void {
  ...
  private static addAsync_9(commandType: CommandType, parentObject: any, obj: any, line: number, style: number, stringList: List<string>, ctrlList: List<GuiMgControl>, columnCount: number, boolVal: boolean, boolVal1: boolean, number1: number, type: Type, number2: number, obj1: any): void {
    GuiCommandQueue.getInstance().add(commandType, parentObject, obj, line, style, stringList, ctrlList, columnCount, boolVal, boolVal1, number1, type, number2, obj1);
  }

  private static addAsync_10(commandType: CommandType, parentObject: any, obj: any, line: number, style: number, stringList: List<string>, ctrlList: List<GuiMgControl>, columnCount: number, boolVal: boolean, boolVal1: boolean, number1: number, type: Type, number2: number, obj1: any, isParentHelpWindow: boolean, dockingStyle: DockingStyle): void {
    GuiCommandQueue.getInstance().add(commandType, parentObject, obj, line, style, stringList, ctrlList, columnCount, boolVal, boolVal1, number1, type, number2, obj1, isParentHelpWindow, dockingStyle);
  }
