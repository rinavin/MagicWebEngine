...
import {OSEnvironment, Logger_LogLevels, DataViewOutputType} from "@magic/utils";
...
export class Events {
  ...
  static BrowserStatusTxtChangeEvent: (browserCtrl: GuiMgControl, text: string) => void = null;

  /// <summary> invokes the BrowserExternal Event</summary>
  /// <param name="browserCtrl"></param>
  /// <param name="text"></param>
  static BrowserExternalEvent: (browserCtrl: GuiMgControl, text: string) => void = null;
  ...
  /// <param name="ctrl"></param>
  static WideEvent: (ctrl: GuiMgControl) => void=  null;
  ...
  /// <param name="line"></param>
  static OnOpenContextMenuEvent: (guiMgCtrl: GuiMgControl, guiMgForm: GuiMgForm, left: number, top: number, line: number) => void = null;
  ...
  /// <param name="browserCtrl"></param>
  /// <param name="text"></param>
  static OnBrowserStatusTxtChange(browserCtrl: GuiMgControl, text: string): void {
    if (Events.BrowserStatusTxtChangeEvent !== null) {
      Events.BrowserStatusTxtChangeEvent(browserCtrl, text);
    }
  }
  ...
  /// <param name="browserCtrl"></param>
  /// <param name="text"></param>
  static OnBrowserExternalEvent(browserCtrl: GuiMgControl, text: string): void {
    if (Events.BrowserExternalEvent !== null) {
      Events.BrowserExternalEvent(browserCtrl, text);
    }
  }
  ...
  static OnKeyDown(form: GuiMgForm, guiMgCtrlOrCtrl: GuiMgControl, modifier: Modifiers, keyCode: number, startOrSuggestedValue: any, endOrComboIsDropDown: any, textOrHandled: any, isActChar?: boolean, suggestedValue?: string, comboIsDropDownOrHandled?: boolean, handled?: boolean): void {
    if (arguments.length === 11 && (form === null || form instanceof GuiMgForm) && (guiMgCtrlOrCtrl === null || guiMgCtrlOrCtrl instanceof GuiMgControl) && (modifier === null || modifier.constructor === Number) && (keyCode === null || keyCode.constructor === Number) && (startOrSuggestedValue === null || startOrSuggestedValue.constructor === Number) && (endOrComboIsDropDown === null || endOrComboIsDropDown.constructor === Number) && (textOrHandled === null || textOrHandled.constructor === String) && (isActChar === null || isActChar.constructor === Boolean) && (suggestedValue === null || suggestedValue.constructor === String) && (comboIsDropDownOrHandled === null || comboIsDropDownOrHandled.constructor === Boolean) && (handled === null || handled.constructor === Boolean)) {
    ...
    if (arguments.length === 10 && (form === null || form instanceof GuiMgForm) && (guiMgCtrlOrCtrl === null || guiMgCtrlOrCtrl instanceof GuiMgControl) && (modifier === null || modifier.constructor === Number) && (keyCode === null || keyCode.constructor === Number) && (startOrSuggestedValue === null || startOrSuggestedValue.constructor === Number) && (endOrComboIsDropDown === null || endOrComboIsDropDown.constructor === Number) && (textOrHandled === null || textOrHandled.constructor === String) && (isActChar === null || isActChar.constructor === Boolean) && (suggestedValue === null || suggestedValue.constructor === String) && (comboIsDropDownOrHandled === null || comboIsDropDownOrHandled.constructor === Boolean)) {
  ...
  /// <summary> invokes the Wide Event</summary>
  /// <param name="ctrl"></param>
  static OnWide(ctrl: GuiMgControl): void {
    Debug.Assert(Events.WideEvent !== null);
    Events.WideEvent(ctrl);
  }
  ...
  /// <param name="top"></param>
  /// <param name="line"></param>
  static OnOpenContextMenu(guiMgCtrl: GuiMgControl, guiMgForm: GuiMgForm, left: number, top: number, line: number): void {
    if (Events.OnOpenContextMenuEvent !== null) {
      Events.OnOpenContextMenuEvent(guiMgCtrl, guiMgForm, left, top, line);
    }
  }
  ...
  /// <param name="ctlIdx"></param>
  /// <returns></returns>
  static GetApplicationMenus(contextID: number, ctlIdx: number): ApplicationMenus {
    Debug.Assert(Events.GetApplicationMenusEvent !== null);
    return Events.GetApplicationMenusEvent(contextID, ctlIdx);
  }
  ...
  static GetMessageString(msgId: string): string {
    ...
    if (text !== null && NString.EndsWith(text, ":")) {
  ...
  private static WriteExceptionToLog_0(msg: string): void {
    Debug.Assert(Events.WriteExceptionToLogEvent !== null);
    Events.WriteExceptionToLogEvent(msg);
  }
  ...
  private static WriteWarningToLog_1(ex: Exception): void {
    Events.WriteWarningToLog(NString.Concat([
      ex.GetType(), " : ", OSEnvironment.EolSeq, ex.StackTrace, OSEnvironment.EolSeq, ex.Message
    ]));
  }
