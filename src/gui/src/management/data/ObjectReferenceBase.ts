import {Debug, IDisposable, NString, StackTrace} from "@magic/mscorelib";
import {IReferencedObject} from "./IReferencedObject";
import {Logger, Logger_LogLevels} from "@magic/utils";

export abstract class ObjectReferenceBase implements IDisposable {
...
//   }
  ...
  ToString(): string {
    return NString.Concat(["{Reference ", this.id, " to: ", this.Referent, "}"]);
  }
}
