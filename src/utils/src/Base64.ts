import {NObject, Encoding, Exception, ApplicationException} from "@magic/mscorelib";
import {ISO_8859_1_Encoding, Misc, StrUtil} from "../index";

export class Base64 extends NObject {
  private static _base64EncMap: Uint8Array = null;
  private static _base64DecMap: Uint8Array = null;
  ...
  static encode(strOrData: any, encodingOrIsUseEnvCharset?: any, encoding?: Encoding): any {
    if (arguments.length === 2 && (strOrData === null || strOrData.constructor === String) && (encodingOrIsUseEnvCharset === null || encodingOrIsUseEnvCharset instanceof Encoding)) {
      return Base64.encode_0(strOrData, encodingOrIsUseEnvCharset);
    }
    if (arguments.length === 3 && (strOrData === null || strOrData.constructor === String) && (encodingOrIsUseEnvCharset === null || encodingOrIsUseEnvCharset.constructor === Boolean) && (encoding === null || encoding instanceof Encoding)) {
  ...
  private static encode_2(data: Uint8Array): Uint8Array {
    ...
    let dest: Uint8Array = new Uint8Array((data.length + 2) / 3 * 4);
    let sidx: number = 0;
    let didx: number = 0;
  ...
  static decode(strOrData: any, encoding?: Encoding): any {
    ...
    if (arguments.length === 2 && (strOrData === null || strOrData.constructor === String) && (encoding === null || encoding instanceof Encoding)) {
  ...
  private static decode_2(data: Uint8Array): Uint8Array {
    ...
    let dest: Uint8Array = new Uint8Array(tail - data.length / 4);
  ...
  static Base64_cctor(): void {
    // Class Initializer
    // rfc-2045: Base64 Alphabet

    // Following values are ASCII values of A-Z, a-z, 0-9, +, /
    let base64EncMap: Uint8Array = new Uint8Array([
    ...
    Base64._base64EncMap = base64EncMap;
    Base64._base64DecMap = new Uint8Array(128);

    for (let i: number = 0; i < Base64._base64EncMap.length; i = i + 1) {
      Base64._base64DecMap[Base64._base64EncMap[i]] = i;
    }
  }
}
