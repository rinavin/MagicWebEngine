import {Char, IComparable, Int32, List, NObject, NString, StringBuilder} from "@magic/mscorelib";
import {ForceExit, Priority, XmlParser, InternalInterface, XMLConstants} from "@magic/utils";
import {
  MenuEntryEvent, LastFocusedVal, MenuEntryProgram, MenuEntryOSCommand, Property,
  PropInterface, Modifiers, MgControlBase,
} from "@magic/gui";
...
export class RunTimeEvent extends Event implements IComparable {
  ...
  constructor(taskRefOrCtrlRefOrTaskrefOrFldRefOrEvtOrMenuEntryEventOrMenuEntryProgramOrOsCommand: any, ctrlRefOrGuiTriggeredEventOrLineOrControlsListOrDirectionOrColumnHeaderOrRtEvtOrCurrentTask?: any, ignoreSpecifiedControlOrGuiTriggeredEventOrLineOrXOrControlOrActivatedFromMDIFrame?: any, yOrCtlIdx?: number, width?: number, height?: number) {
    ...
    if (arguments.length === 1 && (taskRefOrCtrlRefOrTaskrefOrFldRefOrEvtOrMenuEntryEventOrMenuEntryProgramOrOsCommand === null || taskRefOrCtrlRefOrTaskrefOrFldRefOrEvtOrMenuEntryEventOrMenuEntryProgramOrOsCommand instanceof MgControl)) {
    ...
    if (arguments.length === 1 && (taskRefOrCtrlRefOrTaskrefOrFldRefOrEvtOrMenuEntryEventOrMenuEntryProgramOrOsCommand === null || taskRefOrCtrlRefOrTaskrefOrFldRefOrEvtOrMenuEntryEventOrMenuEntryProgramOrOsCommand instanceof Field)) {
    ...
    if (arguments.length === 6 && (taskRefOrCtrlRefOrTaskrefOrFldRefOrEvtOrMenuEntryEventOrMenuEntryProgramOrOsCommand === null || taskRefOrCtrlRefOrTaskrefOrFldRefOrEvtOrMenuEntryEventOrMenuEntryProgramOrOsCommand instanceof MgControl) && (ctrlRefOrGuiTriggeredEventOrLineOrControlsListOrDirectionOrColumnHeaderOrRtEvtOrCurrentTask === null || ctrlRefOrGuiTriggeredEventOrLineOrControlsListOrDirectionOrColumnHeaderOrRtEvtOrCurrentTask.constructor === String) && (ignoreSpecifiedControlOrGuiTriggeredEventOrLineOrXOrControlOrActivatedFromMDIFrame === null || ignoreSpecifiedControlOrGuiTriggeredEventOrLineOrXOrControlOrActivatedFromMDIFrame.constructor === Number) && (yOrCtlIdx === null || yOrCtlIdx.constructor === Number) && (width === null || width.constructor === Number) && (height === null || height.constructor === Number)) {
    ...
    if (arguments.length === 4 && (taskRefOrCtrlRefOrTaskrefOrFldRefOrEvtOrMenuEntryEventOrMenuEntryProgramOrOsCommand === null || taskRefOrCtrlRefOrTaskrefOrFldRefOrEvtOrMenuEntryEventOrMenuEntryProgramOrOsCommand instanceof MenuEntryEvent) && (ctrlRefOrGuiTriggeredEventOrLineOrControlsListOrDirectionOrColumnHeaderOrRtEvtOrCurrentTask === null || ctrlRefOrGuiTriggeredEventOrLineOrControlsListOrDirectionOrColumnHeaderOrRtEvtOrCurrentTask instanceof Task) && (ignoreSpecifiedControlOrGuiTriggeredEventOrLineOrXOrControlOrActivatedFromMDIFrame === null || ignoreSpecifiedControlOrGuiTriggeredEventOrLineOrXOrControlOrActivatedFromMDIFrame instanceof MgControl) && (yOrCtlIdx === null || yOrCtlIdx.constructor === Number)) {
  ...
  private constructor_7(ctrlRef: MgControl): void {
    ...
    if (ctrlRef !== null && super.getType() === Char.MinValue) // not initialized yet
    {
      ...
      let prop: Property = ctrlRef.getProp(PropInterface.PROP_TYPE_TRIGGER);
      if (prop !== null) {
        let xmlParser: XmlParser = new XmlParser(prop.getValue());
  ...
  replicate(): RunTimeEvent {
    let runTimeEvent: RunTimeEvent = <RunTimeEvent> super.MemberwiseClone();
